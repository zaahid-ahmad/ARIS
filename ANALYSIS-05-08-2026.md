...
**Last updated:** 2026-08-27 — Teacher At-Risk scatter chart (attendance vs. academic average), Teacher Dashboard alert simplified to a click-through banner, and three double-click/race-condition crashes found and fixed across the app. Changes marked ✅ *2026-08-27* below.
**Previously:** 2026-08-26 — Sprint 3: learner/teacher alert notifications, bulk user import (CSV/Excel), password recovery for admins, bulk subject allocation by class. Changes marked ✅ *Sprint 3*.
