...
namespace ARIS1.Migrations
{
    ...
    [Migration("20260915110010_AddLearningResources")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ARIS1.Models.EmailLog", b =>
                {
                    ...
                    b.Property<string>("DeliveredToAddress")
                        .HasMaxLength(256)
                    ...
                    b.HasIndex("SchoolId", "CreatedUtc");
            ...
            modelBuilder.Entity("ARIS1.Models.LearnerYearSubjectRisk", b =>
                {
                    b.Property<int>("LearnerYearSubjectRiskId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("LearnerYearSubjectRiskId"));

                    b.Property<decimal>("AcademicAverage")
                        .HasColumnType("decimal(10,4)");
                    ...
                    b.HasKey("LearnerYearSubjectRiskId");
                    ...
                    b.ToTable("LearnerYearSubjectRisks");
                });

            modelBuilder.Entity("ARIS1.Models.LearningResource", b =>
                {
            ...
            modelBuilder.Entity("ARIS1.Models.ParentAlertState", b =>
                {
                    b.Property<int>("LearnerId")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("LastAlertLevel")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<DateTime>("LastAlertedUtc")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("ARIS1.Models.School", b =>
                {
                    ...
                    b.Property<bool>("ParentAlertsEnabled")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("ARIS1.Models.LearningResource", b =>
                {
                    ...
                    b.HasOne("ARIS1.Models.User", "UploadedBy")
                        .WithMany()
